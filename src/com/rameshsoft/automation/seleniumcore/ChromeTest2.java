...
public class ChromeTest2 {
	public static void main(String[] args) throws InterruptedException {
		...
		//here we are using Remotewebdriver as a reference we can identifing the elements with By mechanisum, with out By mechanisum also.
		
		RemoteWebDriver driver = new ChromeDriver();// here we can use romotewebdriver with by element on two approaches..
	   ...
	   // i wnat to enter the url.
		...
		//WebElement nxt = driver.findElementById("identifier");//third approach
		//2.perform the action
		nxt.click();
	...
	*/
		...
		//so we using webdriver as the reference compulsary in order to identify the elements we should you By mechanisum mandatory.(line36,46).
